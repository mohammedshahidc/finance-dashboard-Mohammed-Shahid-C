...
const SettingsComponent = () => {
  ...
  const { transactions } = useContext(TransactionContext);
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-red-600 mb-2">Context Error</h2>
                    <p className="text-gray-600">User context is not available. Please check your context provider.</p>
                </div>
            </div>
        );
    }

    const { user, updateUser,getUser } = contextValue;
    ...
    const [profile, setProfile] = useState({ name: '', email: '', currency: 'INR' });
    ...
    const handleProfileSave = () => {
        try {
            const editedUser = { name, email, currency };
            ...
            reader.onload = (e) => {
                try {
                    ...
                    if (data.profile && typeof data.profile === 'object') {
                        ...
                        setCurrency(importedProfile.currency);
                    }
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {isEditingProfile ? (
                                        ...
                                        <p className={`px-4 py-3 rounded-xl ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-50 text-gray-800'
                                            } font-medium`}>
                                ...
                                <div>
                                    ...
                                    {isEditingProfile ? (
                                        ...
                                        <p className={`px-4 py-3 rounded-xl ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-50 text-gray-800'
                                            ...
                                            {getCurrencySymbol(profile.currency)} {currencies.find(c => c.code === profile.currency)?.name || 'Indian Rupee'}
                                        </p>
                                    )}
                                </div>
                                ...
                                {isEditingProfile && (
                                    <div className="flex space-x-4">
                                        ...
                                        <button
                                            ...
                                            className={`flex-1 px-6 py-3 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center ${isDarkMode
                        ...
                        <div className={`${isDarkMode
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4">
                                    <div className={`p-3 rounded-xl ${isDarkMode ? 'bg-yellow-500/20' : 'bg-gray-100'
                                        }`}>
                                        {isDarkMode ? (
                                ...
                                <button
                                    ...
                                    className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors duration-200 ${isDarkMode ? 'bg-purple-600' : 'bg-gray-200'
                                        }`}
                                >
                                    <span
                    ...
                    <div>
                        <div className={`${isDarkMode
                            ...
                            <div className={`p-6 rounded-xl border transition-all duration-200 hover:shadow-lg ${isDarkMode
                        ...
                        <div className={`${isDarkMode
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button className={`p-4 rounded-xl border transition-all duration-200 hover:shadow-lg ${isDarkMode
                                ...
                                <button className={`p-4 rounded-xl border transition-all duration-200 hover:shadow-lg ${isDarkMode
                                    ...
                                    <div className="text-center" onClick={handleBackup}>
                        ...
                        <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
                            ...
                            <div className="flex space-x-4">
                                ...
                                <button
                                    ...
                                    className={`flex-1 px-6 py-3 rounded-xl font-semibold transition-all duration-200 ${isDarkMode
                                        ? 'bg-gray-600 text-white hover:bg-gray-500'
                                        : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                        }`}
                                >
